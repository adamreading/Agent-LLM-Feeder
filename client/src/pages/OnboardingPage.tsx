...
const PROVIDERS: { id: Platform; name: string; tier: string; prefix: string; accountUrl: string; keyUrl: string; note?: string }[] = [
  ...
  { id: 'vercel', name: 'Vercel AI Gateway', tier: '$5 FREE / MONTH · 9 "-FREE" MODELS (minimax-m3-free…)', prefix: 'vck_…', accountUrl: 'https://vercel.com/ai-gateway', keyUrl: 'https://vercel.com/ai-gateway',
    note: 'CARD REQUIRED on the Vercel team to unlock the free credit. Overage HARD-STOPS (402) — leave Auto Top-Up OFF (it is off by default; ON = auto-charge). Buying credits ends the free tier for good. Only "-free" models are enabled here.' },
  ...
  { id: 'hetzner', name: 'Hetzner Inference', tier: 'FREE WHILE EXPERIMENTAL · 10 REQ/MIN · Qwen3.6-35B / Qwen3.8-27B', prefix: '…', accountUrl: 'https://console.hetzner.cloud', keyUrl: 'https://docs.hetzner.com/general/company-and-policy/experiments/inference/',
    note: 'Hetzner may demand a CARD and/or passport ID verification before issuing a token. Free only while "experimental" (they email before that changes); no billing exists, hard 429 at the limit. Small Qwen models only.' },
]
